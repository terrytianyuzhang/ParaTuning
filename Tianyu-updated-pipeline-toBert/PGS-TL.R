...
#####Prepare the Lassosum beta file (which was trained with CEU data)
#READ AUC.weighted
...
#READ lassosum beta, which is the output file of the lassosum package
